...
export default function CookiesPage () {
  return (
    <div className="legalPage__content">
      <h1>Política de Cookies de Rozaviht</h1>
      <p>Rozaviht informa acerca del uso de las cookies en su página web: www.rozaviht.com</p>
      ...
      <ul>
        <li>
          <p>
          Microsoft Internet Explorer o Microsoft Edge: <a href="http://windows.microsoft.com/eses/">http://windows.microsoft.com/eses/</a>
          windows-vista/Block-or-allow-cookies
          </p>
        </li>
        <li>
          <p>
          Mozilla Firefox: <a href="http://support.mozilla.org/es/kb/impedir-que-los-sitios-webguarden-
          sus-preferencia">http://support.mozilla.org/es/kb/impedir-que-los-sitios-webguarden-
          sus-preferencia</a>
          </p>
        </li>
        <li>
          <p>
          Safari: <a href="http://safari.helpmax.net/es/privacidad-y-seguridad/como-gestionar-lascookies/">http://safari.helpmax.net/es/privacidad-y-seguridad/como-gestionar-lascookies/</a>
          </p>
        </li>
        <li>
          <p>
          Opera: <a href="http://help.opera.com/Linux/10.60/es-ES/cookies.html">http://help.opera.com/Linux/10.60/es-ES/cookies.html</a>
          </p>
        </li>
        <li>
          <p>
          Chrome: <a href="https://support.google.com/accounts/answer/61416?hl=es">https://support.google.com/accounts/answer/61416?hl=es</a>
          </p>
        </li>
      </ul>
      <h3>Aceptación de la Pólitica de cookies</h3>
      <p>
      www.rozaviht.com asume que usted acepta el uso de cookies. No obstante, muestra

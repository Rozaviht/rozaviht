import type { MiniTermsPrivacyProps } from "./MiniTerms"

export default function MiniPrivacy ({showComponent, handleShowMiniTerms, index}: MiniTermsPrivacyProps) {
  return ( 
        <div className={showComponent === true ? 'miniTerms' : 'miniTerms hidden'}>
            ...
            <h3>NUESTRA POLÍTICA DE PRIVACIDAD Y SEGURIDAD</h3>
            <div className='flexcolum flexcolum--separate flexcolum--nopd'>
              ...
              <h4>USO DE DATOS PORQUE Y PARA QUE</h4>
              <p>
              ...
              <h4>LEGITIMACIÓN Y NORMATIVA PARA EL TRATAMIENTO DE LOS DATOS</h4>
              <p>
